...
- **Modify**: `templates/profile.html`
  - All four dynamic sections are already present — no structural changes needed,
...
- Response contains the seed user's email ("demo@my.com")
...
## Definition of done
- [ ] Logging in as the seed user (demo@my.com / demo123) shows "Demo User" and "demo@my.com" on the profile page — not the hardcoded strings
